...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-zNvfVjQN.mjs");
...
var manifest = {
	"3407d050248c8440995c0edee38b769631be091324d0c4f717d1864c591ba474": {
		functionName: "aiAvailable_createServerFn_handler",
		importer: () => import("./fns-C7CQsLzu.mjs")
	},
	"4bc345dd980f4a6a961ad87fce85c7f47abc56a42400d6df0d775241a05df1cd": {
		functionName: "beginVideo_createServerFn_handler",
		importer: () => import("./fns-C7CQsLzu.mjs")
	},
	"548a0170ca59a8f55e4b9bacf6801cb0445222b696d58cec605ee324d030d8fb": {
		functionName: "analyzeTranscript_createServerFn_handler",
		importer: () => import("./fns-C7CQsLzu.mjs")
	},
	"7f628762c8a4c9c5de1180adf33d9ce2ff54746876e7f97f743dc3c979ecbc8b": {
		functionName: "checkVideo_createServerFn_handler",
		importer: () => import("./fns-C7CQsLzu.mjs")
	},
	"9c1976646ab64fefcb6eaa94cc6c4abe8071d1cc5e83383a0bc39d5dddfeefbb": {
		functionName: "makePortrait_createServerFn_handler",
		importer: () => import("./fns-C7CQsLzu.mjs")
	},
	"a45f9d6f13d0f80944c5d2d5ce4baaea9ada2a273b884e9ee3b84113e8b2751a": {
		functionName: "makeScene_createServerFn_handler",
		importer: () => import("./fns-C7CQsLzu.mjs")
	}
};
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-BmawLhnN.mjs").then((n) => n.t),
